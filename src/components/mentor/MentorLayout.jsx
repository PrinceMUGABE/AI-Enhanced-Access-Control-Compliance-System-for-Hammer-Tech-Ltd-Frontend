...
export default function MentorLayout() {
  ...
  const navigationItems = [
    ...
    { icon: Users, label: "Mentorship", path: "/mentor/mentorship" },
    { icon: MessageSquare, label: "Communication", path: "/mentor/communication" },
    { icon: Bot, label: "AI Assistant", path: "/mentor/chatbot" },
  ];
      ...
      <header className="bg-white border-b sticky top-0 z-40 h-16">
        <div className="flex items-center justify-between px-4 h-full">
          <div className="flex items-center gap-4">
            ...
            <Link to="/mentee" className="flex items-center gap-2">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <div className="hidden lg:block text-left">
                  <div className="text-sm font-medium">{user?.full_name || user?.name || 'Mentor'}</div>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border py-1 z-50">
                  <div className="px-4 py-3 border-b">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium">{user?.full_name || user?.name || 'Mentee'}</div>
                        <div className="text-xs text-gray-500">{user?.work_mail_address || user?.email || ''}</div>
